    ...
    return (
            ...
            >
                ...
                <div>
                    ...
                    <p className="text-about" id="body">Looking for your next 10x, but don't know where to start? We got you. Stay tuned for our digital memecoin newsletter <span className="small-logo-sentence">(Coming Phase 3)</span> that gets distributed <span className="bold">weekly</span> to $FOWBES holders. Holders who launch memecoins will also have the chance each month to be featured in one of our issues.</p>
                </div>
            </div>   
    );
};
